        ...
        <>
            ...
            <div className='LSH-StudySelectPopover'>
                <fieldset onChange={(e) => handleStudyChange(e)}>
                    ...
                    <input type="checkbox" name="study" id="rsi" checked={studyChangeCapture.includes('rsi')} />

                    <label htmlFor="MACD">MACD</label>
                    <input type="checkbox" name="study" id="MACD" checked={studyChangeCapture.includes('MACD')} />
