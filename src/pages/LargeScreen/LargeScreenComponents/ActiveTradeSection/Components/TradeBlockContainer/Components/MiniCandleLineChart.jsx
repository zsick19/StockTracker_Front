...
function MiniCandleLineChart({ tickerSymbol, openPrice, enterPrice, enterBufferPrice, stopLossPrice, direction, xScaleFromCandles, yesterdayCandles })
{

    const candleData = useSelector((state) => selectTodaysCandlesByTicker(state, tickerSymbol))
...
export default MiniCandleLineChart