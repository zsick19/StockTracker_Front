...
import { addBusinessDays, isWeekend, previousFriday } from 'date-fns'
import { useResizeObserver } from '../../../../../../../../hooks/useResizeObserver'

function TwoDayFiveMinChart({ candleData, openPrice, enterPrice, enterBufferPrice, stopLossPrice, direction, xScaleFromCandles })
{
    ...
    const createDateScale = useCallback((dateToPixel) =>
    {
        ...
        let endOfTradingDay
        if (xScaleFromCandles)
        {
            startOfTradingDay = new Date(candleData[0].Timestamp)
            endOfTradingDay = addBusinessDays(startOfTradingDay, 1)
...
export default TwoDayFiveMinChart