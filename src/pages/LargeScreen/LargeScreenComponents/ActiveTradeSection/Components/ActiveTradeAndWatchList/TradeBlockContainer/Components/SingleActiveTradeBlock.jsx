                ...
                <div>
                    ...
                    {showTradeOptions ?
                        ...
                        : <div className='TimeFrameOptions'>
                            <div className='flex'>
                                <p>Day's P/L:</p>
                                <p className={activeTrade?.todaysGain > 0 ? 'positiveDirection' : 'negativeDirection'}>${activeTrade?.todaysGain.toFixed(2)}</p>
                                <p className={activeTrade?.todaysGain > 0 ? 'positiveDirection' : 'negativeDirection'}>{activeTrade.todaysGainPercent.toFixed(2)}%</p>
                            </div>
