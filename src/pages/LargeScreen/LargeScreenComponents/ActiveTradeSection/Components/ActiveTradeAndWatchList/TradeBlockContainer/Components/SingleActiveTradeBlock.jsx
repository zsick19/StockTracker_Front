    ...
    return (
        <div className={`LSH-ActiveTradeBlock ${activeTrade.classVisual}`}>
            ...
            <div className='TradeInfoSection'>
                <div>
                    ...
                    <div className='PriceTickerInfo'>
                        ...
                        <div className='PriceMovementPerTrade' onClick={() => handleStockToTradeChart()}>
                            <h2 className={activeTrade.priceDirection}>${activeTrade.mostRecentPrice.toFixed(2)}</h2>
                ...
                <div>
                    {showStopEnterExit === 0 ? <div className={activeTrade.percentFromOpen >= 0 ? 'activeTradePositive currentPL' : 'activeTradeNegative currentPL'} onClick={() => setShowStopEnterExit(1)}>
                        ...
                        <div>
                            <p>Open P/L: ${(activeTrade.gainPerShare * activeTrade.availableShares).toFixed(2)}</p>
                            <p>Day's P/L: ${activeTrade?.todaysGain.toFixed(2)}</p>
                        </div>
                    </div> :
                        showStopEnterExit === 1 ? <div className='PlanStopEnterExit' onClick={() => setShowStopEnterExit(2)}>
                            <div>
                            ...
                            showStopEnterExit === 2 ? <div className='PlanStopEnterExit' onClick={() => setShowStopEnterExit(3)}>
                                <div>
